(((668 "")
  (668 668
       ("pkg_member" "pkg_var" "new" "randomize()")
       :annotation-function verilog-ext-capf-annotation-function :company-docsig identity))
 ((678 "")
  (678 678
       ("insert()" "pop_front()" "pop_back()" "push_front()" "push_back()" "size()" "delete()" "insert()" "pop_front()" "pop_back()" "push_front()" "push_back()" "size()" "delete()")
       :annotation-function verilog-ext-capf-annotation-function :company-docsig identity))
 ((688 "")
  (688 688
 ...
 ((751 "")
  (751 751
       ("A" "B" "name()" "num()" "first()" "last()" "next()" "prev()")
       :annotation-function verilog-ext-capf-annotation-function :company-docsig identity))
 ((762 "")
  (762 762
       ("A" "B" "name()" "num()" "first()" "last()" "next()" "prev()")
 ...
 ((769 "")
  (769 769
       ("len()" "putc()" "getc()" "toupper()" "tolower()" "compare()" "icompare()" "substr()" "atoi()" "atohex()" "atooct()" "atobin()" "atoreal()" "itoa()" "hextoa()" "octtoa()" "bintoa()" "realtoa()" "len()" "putc()" "getc()" "toupper()" "tolower()" "compare()" "icompare()" "substr()" "atoi()" "atohex()" "atooct()" "atobin()" "atoreal()" "itoa()" "hextoa()" "octtoa()" "bintoa()" "realtoa()")
       :annotation-function verilog-ext-capf-annotation-function :company-docsig identity))
 ((805 "")
  (805 805
       ("pkg_cls")
