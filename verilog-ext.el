...
;; Package-Requires: ((emacs "29.1") (verilog-mode "2024.3.1.121933719") (verilog-ts-mode "0.6.0") (lsp-mode "8.0.0") (rg "2.3.0") (hydra "0.15.0") (apheleia "3.1") (yasnippet "0.14.0") (flycheck "32") (async "1.9.7"))
...
(declare-function verilog-ext-navigation-rg-hook "verilog-ext-nav")
...
(defun verilog-ext-mode-setup ()
  ...
  (add-hook 'rg-finish-functions #'verilog-ext-navigation-rg-hook))
